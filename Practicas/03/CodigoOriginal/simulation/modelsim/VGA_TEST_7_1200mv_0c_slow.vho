...
-- VGA_SYNC_N	=>  Location: PIN_AH20,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \C|altpll_0|sd1|wire_pll7_clk[0]~clkctrl_e_VGA_CLK_INCLK_bus\ : std_logic_vector(3 DOWNTO 0);
...
SIGNAL \C|altpll_0|sd1|wire_pll7_clk[0]~clkctrl_e_VGA_CLK_outclk\ : std_logic;
...
\C|altpll_0|sd1|wire_pll7_clk[0]~clkctrl_e_VGA_CLK_INCLK_bus\ <= (vcc & vcc & vcc & \C|altpll_0|sd1|wire_pll7_clk\(0));
...
\C1|Add1~0\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|Add1~14\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|Add0~0\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|Add0~2\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|Add0~4\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|Add0~6\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|Add0~8\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|Add0~10\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|Add0~12\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|Add0~14\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan1~1\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan1~3\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan1~5\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan1~7\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan1~9\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan1~11\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan1~13\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan1~15\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan1~17\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan1~19\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan1~20\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan0~5\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan0~7\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan0~9\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan0~11\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan0~13\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan0~15\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan0~17\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan0~19\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan0~20\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|Add3~0\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|Add3~2\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|Add3~4\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|Add3~6\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|Add3~8\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|Add3~10\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|Add3~12\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|Add3~14\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan7~1\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan7~3\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan7~5\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan7~7\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan7~9\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan7~11\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan7~13\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan7~15\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan7~17\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan7~19\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan7~20\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|Add2~12\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|HPOS[2]~15\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|HPOS[8]~27\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|Add6~9\ : cycloneiv_lcell_comb
-- Equation(s):
-- \C1|Add6~9_combout\ = ((\C1|SQ_X1\(4) $ (\KEY[1]~input_o\ $ (!\C1|Add6~8\)))) # (GND)
-- \C1|Add6~10\ = CARRY((\C1|SQ_X1\(4) & (!\KEY[1]~input_o\ & !\C1|Add6~8\)) # (!\C1|SQ_X1\(4) & ((!\C1|Add6~8\) # (!\KEY[1]~input_o\))))
...
\C1|Add13~3\ : cycloneiv_lcell_comb
-- Equation(s):
-- \C1|Add13~3_combout\ = (\C1|SQ_Y2\(1) & ((\KEY[3]~input_o\ & (\C1|Add13~2\ & VCC)) # (!\KEY[3]~input_o\ & (!\C1|Add13~2\)))) # (!\C1|SQ_Y2\(1) & ((\KEY[3]~input_o\ & (!\C1|Add13~2\)) # (!\KEY[3]~input_o\ & ((\C1|Add13~2\) # (GND)))))
-- \C1|Add13~4\ = CARRY((\C1|SQ_Y2\(1) & (!\KEY[3]~input_o\ & !\C1|Add13~2\)) # (!\C1|SQ_Y2\(1) & ((!\C1|Add13~2\) # (!\KEY[3]~input_o\))))
...
\C1|Add13~5\ : cycloneiv_lcell_comb
-- Equation(s):
-- \C1|Add13~5_combout\ = ((\C1|SQ_Y2\(2) $ (\KEY[3]~input_o\ $ (\C1|Add13~4\)))) # (GND)
-- \C1|Add13~6\ = CARRY((\C1|SQ_Y2\(2) & ((!\C1|Add13~4\) # (!\KEY[3]~input_o\))) # (!\C1|SQ_Y2\(2) & (!\KEY[3]~input_o\ & !\C1|Add13~4\)))
...
\C1|Add13~11\ : cycloneiv_lcell_comb
-- Equation(s):
-- \C1|Add13~11_combout\ = (\C1|SQ_Y2\(5) & ((\KEY[3]~input_o\ & (\C1|Add13~10\ & VCC)) # (!\KEY[3]~input_o\ & (!\C1|Add13~10\)))) # (!\C1|SQ_Y2\(5) & ((\KEY[3]~input_o\ & (!\C1|Add13~10\)) # (!\KEY[3]~input_o\ & ((\C1|Add13~10\) # (GND)))))
-- \C1|Add13~12\ = CARRY((\C1|SQ_Y2\(5) & (!\KEY[3]~input_o\ & !\C1|Add13~10\)) # (!\C1|SQ_Y2\(5) & ((!\C1|Add13~10\) # (!\KEY[3]~input_o\))))
...
\C1|LessThan9~1\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|SQ_X1[4]~6\ : cycloneiv_lcell_comb
-- Equation(s):
...
-- pragma translate_on
PORT MAP (
	i => \C|altpll_0|sd1|wire_pll7_clk[0]~clkctrl_e_VGA_CLK_outclk\,
	devoe => ww_devoe,
	o => ww_VGA_CLK);
...
-- Location: PLL_4
\C|altpll_0|sd1|pll7\ : cycloneiv_pll
-- pragma translate_off
GENERIC MAP (
	auto_settings => "false",
...
\C|altpll_0|sd1|wire_pll7_clk[1]~clkctrl\ : cycloneiv_clkctrl
-- pragma translate_off
GENERIC MAP (
...
\C1|HPOS[0]~11\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|HPOS[1]~13\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|HPOS[4]~19\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan8~1\ : cycloneiv_lcell_comb
-- Equation(s):
-- \C1|LessThan8~1_combout\ = (!\C1|HPOS\(5) & (!\C1|HPOS\(6) & ((!\C1|HPOS\(4)) # (!\C1|HPOS\(3)))))
...
\C1|LessThan8~0\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan8~2\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|HPOS[3]~17\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|HPOS[5]~21\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|HPOS[6]~23\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|HPOS[7]~25\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|HPOS[9]~29\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|HPOS[10]~31\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|process_0~4\ : cycloneiv_lcell_comb
-- Equation(s):
-- \C1|process_0~4_combout\ = (\C1|HPOS\(8)) # ((\C1|HPOS\(10)) # (\C1|HPOS\(9)))
...
\C1|process_0~5\ : cycloneiv_lcell_comb
-- Equation(s):
-- \C1|process_0~5_combout\ = (!\C1|HPOS\(2) & (!\C1|HPOS\(1) & (!\C1|HPOS\(0) & !\C1|HPOS\(3))))
...
\C1|process_0~6\ : cycloneiv_lcell_comb
-- Equation(s):
-- \C1|process_0~6_combout\ = (\C1|HPOS\(5) & ((\C1|HPOS\(7)) # ((\C1|HPOS\(4) & !\C1|process_0~5_combout\))))
...
\C1|process_0~7\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|VPOS[0]~11\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|VPOS[3]~17\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|VPOS[4]~19\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|VPOS[5]~21\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|VPOS[6]~23\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|VPOS[7]~25\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|VPOS[8]~27\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|VPOS[9]~29\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan9~0\ : cycloneiv_lcell_comb
-- Equation(s):
-- \C1|LessThan9~0_combout\ = (!\C1|VPOS\(7) & (!\C1|VPOS\(8) & (!\C1|VPOS\(6) & !\C1|VPOS\(9))))
...
\C1|VPOS[10]~31\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan9~2\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|VPOS[1]~13\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|VPOS[2]~15\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|process_0~8\ : cycloneiv_lcell_comb
-- Equation(s):
-- \C1|process_0~8_combout\ = (\C1|VPOS\(3)) # ((\C1|VPOS\(2)) # ((!\C1|VPOS\(1) & !\C1|VPOS\(0))))
...
\C1|process_0~9\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|process_0~10\ : cycloneiv_lcell_comb
-- Equation(s):
-- \C1|process_0~10_combout\ = ((\C1|process_0~8_combout\) # (\C1|process_0~9_combout\)) # (!\C1|LessThan9~0_combout\)
...
\C|altpll_0|sd1|wire_pll7_clk[0]~clkctrl_e_VGA_CLK\ : cycloneiv_clkctrl
-- pragma translate_off
GENERIC MAP (
...
-- pragma translate_on
PORT MAP (
	inclk => \C|altpll_0|sd1|wire_pll7_clk[0]~clkctrl_e_VGA_CLK_INCLK_bus\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	outclk => \C|altpll_0|sd1|wire_pll7_clk[0]~clkctrl_e_VGA_CLK_outclk\);
...
\C1|Add9~1\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|SQ_Y1[10]~0\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|SQ_Y1[10]~1\ : cycloneiv_lcell_comb
-- Equation(s):
-- \C1|SQ_Y1[10]~1_combout\ = (\C1|LessThan8~2_combout\ & (\C1|SQ_Y1[10]~0_combout\ & (\C1|LessThan9~2_combout\ & \SW[0]~input_o\)))
...
\C1|Add9~3\ : cycloneiv_lcell_comb
-- Equation(s):
-- \C1|Add9~3_combout\ = (\C1|SQ_Y1\(1) & ((\KEY[3]~input_o\ & (\C1|Add9~2\ & VCC)) # (!\KEY[3]~input_o\ & (!\C1|Add9~2\)))) # (!\C1|SQ_Y1\(1) & ((\KEY[3]~input_o\ & (!\C1|Add9~2\)) # (!\KEY[3]~input_o\ & ((\C1|Add9~2\) # (GND)))))
-- \C1|Add9~4\ = CARRY((\C1|SQ_Y1\(1) & (!\KEY[3]~input_o\ & !\C1|Add9~2\)) # (!\C1|SQ_Y1\(1) & ((!\C1|Add9~2\) # (!\KEY[3]~input_o\))))
...
\C1|Add9~5\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|SQ_Y1[2]~7\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|Add9~7\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|Add9~9\ : cycloneiv_lcell_comb
-- Equation(s):
-- \C1|Add9~9_combout\ = ((\KEY[3]~input_o\ $ (\C1|SQ_Y1\(4) $ (\C1|Add9~8\)))) # (GND)
-- \C1|Add9~10\ = CARRY((\KEY[3]~input_o\ & ((!\C1|Add9~8\) # (!\C1|SQ_Y1\(4)))) # (!\KEY[3]~input_o\ & (!\C1|SQ_Y1\(4) & !\C1|Add9~8\)))
...
\C1|SQ_Y1[4]~6\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|Add9~11\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|SQ_Y1[5]~5\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|Add9~13\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|SQ_Y1[6]~4\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|Add9~15\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|SQ_Y1[7]~3\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|Add9~17\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|SQ_Y1[8]~2\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|Add9~19\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|Add9~21\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|Add1~2\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|Add1~4\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|Add1~6\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|Add1~8\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|Add1~10\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|Add1~12\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|Add1~16\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|Add6~1\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|SQ_X1[10]~0\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|SQ_X1[10]~1\ : cycloneiv_lcell_comb
-- Equation(s):
-- \C1|SQ_X1[10]~1_combout\ = (\C1|LessThan9~2_combout\ & (\C1|SQ_X1[10]~0_combout\ & (\C1|LessThan8~2_combout\ & \SW[0]~input_o\)))
...
\C1|Add6~3\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|Add6~5\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|SQ_X1[2]~7\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|Add6~7\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|Add6~11\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|SQ_X1[5]~5\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|Add6~13\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|SQ_X1[6]~4\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|Add6~15\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|SQ_X1[7]~3\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|Add6~17\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|SQ_X1[8]~2\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|Add6~19\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|Add6~21\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|Add0~16\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan3~1\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan3~3\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan3~5\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan3~7\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan3~9\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan3~11\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan3~13\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan3~15\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan3~17\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan3~19\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan3~20\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|DRAW1~0\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan2~1\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan2~3\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan2~5\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan2~7\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan2~9\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan2~11\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan2~13\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan2~15\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan2~17\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan2~19\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan2~20\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|DRAW1~1\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|Add10~1\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|SQ_X2[10]~0\ : cycloneiv_lcell_comb
-- Equation(s):
-- \C1|SQ_X2[10]~0_combout\ = (\C1|LessThan9~2_combout\ & (\C1|SQ_X1[10]~0_combout\ & (\C1|LessThan8~2_combout\ & \SW[1]~input_o\)))
...
\C1|Add10~3\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|Add10~5\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|Add10~7\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|SQ_X2[3]~4\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|Add10~9\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|SQ_X2[4]~3\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|Add10~11\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|Add10~13\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|SQ_X2[6]~2\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|Add10~15\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|Add10~17\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|Add10~19\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|SQ_X2[9]~1\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|Add10~21\ : cycloneiv_lcell_comb
-- Equation(s):
-- \C1|Add10~21_combout\ = \C1|SQ_X2\(10) $ (\C1|Add10~20\ $ (\KEY[1]~input_o\))
...
\C1|LessThan4~1\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan4~3\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan4~5\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan4~7\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan4~9\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan4~11\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan4~13\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan4~15\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan4~17\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan4~19\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan4~20\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|Add13~1\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|SQ_Y2[10]~0\ : cycloneiv_lcell_comb
-- Equation(s):
-- \C1|SQ_Y2[10]~0_combout\ = (\C1|LessThan8~2_combout\ & (\C1|LessThan9~2_combout\ & (\SW[1]~input_o\ & \C1|SQ_Y1[10]~0_combout\)))
...
\C1|Add13~7\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|Add13~9\ : cycloneiv_lcell_comb
-- Equation(s):
-- \C1|Add13~9_combout\ = ((\C1|SQ_Y2\(4) $ (\KEY[3]~input_o\ $ (\C1|Add13~8\)))) # (GND)
-- \C1|Add13~10\ = CARRY((\C1|SQ_Y2\(4) & (\KEY[3]~input_o\ & !\C1|Add13~8\)) # (!\C1|SQ_Y2\(4) & ((\KEY[3]~input_o\) # (!\C1|Add13~8\))))
...
\C1|Add13~13\ : cycloneiv_lcell_comb
-- Equation(s):
-- \C1|Add13~13_combout\ = ((\C1|SQ_Y2\(6) $ (\KEY[3]~input_o\ $ (\C1|Add13~12\)))) # (GND)
-- \C1|Add13~14\ = CARRY((\C1|SQ_Y2\(6) & (\KEY[3]~input_o\ & !\C1|Add13~12\)) # (!\C1|SQ_Y2\(6) & ((\KEY[3]~input_o\) # (!\C1|Add13~12\))))
...
\C1|SQ_Y2[6]~2\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|SQ_Y2[3]~4\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan6~1\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan6~3\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan6~5\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan6~7\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan6~9\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan6~11\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan6~13\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan6~15\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan6~17\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan6~19\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan6~20\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|Add2~0\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|Add2~2\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|Add2~4\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|Add2~6\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|Add2~8\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|Add2~10\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|Add2~14\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|Add2~16\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|Add13~15\ : cycloneiv_lcell_comb
-- Equation(s):
-- \C1|Add13~15_combout\ = (\C1|SQ_Y2\(7) & ((\KEY[3]~input_o\ & (\C1|Add13~14\ & VCC)) # (!\KEY[3]~input_o\ & (!\C1|Add13~14\)))) # (!\C1|SQ_Y2\(7) & ((\KEY[3]~input_o\ & (!\C1|Add13~14\)) # (!\KEY[3]~input_o\ & ((\C1|Add13~14\) # (GND)))))
-- \C1|Add13~16\ = CARRY((\C1|SQ_Y2\(7) & (!\KEY[3]~input_o\ & !\C1|Add13~14\)) # (!\C1|SQ_Y2\(7) & ((!\C1|Add13~14\) # (!\KEY[3]~input_o\))))
...
\C1|Add13~17\ : cycloneiv_lcell_comb
-- Equation(s):
-- \C1|Add13~17_combout\ = ((\C1|SQ_Y2\(8) $ (\KEY[3]~input_o\ $ (!\C1|Add13~16\)))) # (GND)
-- \C1|Add13~18\ = CARRY((\C1|SQ_Y2\(8) & ((\KEY[3]~input_o\) # (!\C1|Add13~16\))) # (!\C1|SQ_Y2\(8) & (\KEY[3]~input_o\ & !\C1|Add13~16\)))
...
\C1|Add13~19\ : cycloneiv_lcell_comb
-- Equation(s):
-- \C1|Add13~19_combout\ = (\C1|SQ_Y2\(9) & ((\KEY[3]~input_o\ & (!\C1|Add13~18\)) # (!\KEY[3]~input_o\ & ((\C1|Add13~18\) # (GND))))) # (!\C1|SQ_Y2\(9) & ((\KEY[3]~input_o\ & (\C1|Add13~18\ & VCC)) # (!\KEY[3]~input_o\ & (!\C1|Add13~18\))))
-- \C1|Add13~20\ = CARRY((\C1|SQ_Y2\(9) & ((!\C1|Add13~18\) # (!\KEY[3]~input_o\))) # (!\C1|SQ_Y2\(9) & (!\KEY[3]~input_o\ & !\C1|Add13~18\)))
...
\C1|Add13~21\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|SQ_Y2[9]~1\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|SQ_Y2[4]~3\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|Add3~16\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan5~1\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan5~3\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan5~5\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan5~7\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan5~9\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan5~11\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan5~13\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan5~15\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan5~17\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|LessThan5~19\ : cycloneiv_lcell_comb
-- Equation(s):
-- \C1|LessThan5~19_cout\ = CARRY((\C1|Add2~12_combout\ & (\C1|HPOS\(9) & !\C1|LessThan5~17_cout\)) # (!\C1|Add2~12_combout\ & ((\C1|HPOS\(9)) # (!\C1|LessThan5~17_cout\))))
...
\C1|LessThan5~20\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|DRAW2~0\ : cycloneiv_lcell_comb
-- Equation(s):
-- \C1|DRAW2~0_combout\ = (\C1|LessThan7~20_combout\ & ((\C1|Add2~16_combout\) # ((\C1|LessThan5~20_combout\)))) # (!\C1|LessThan7~20_combout\ & (\C1|Add3~16_combout\ & ((\C1|Add2~16_combout\) # (\C1|LessThan5~20_combout\))))
...
\C1|DRAW2~1\ : cycloneiv_lcell_comb
-- Equation(s):
...
\C1|B~0\ : cycloneiv_lcell_comb
-- Equation(s):
-- \C1|B~0_combout\ = (\C1|DRAW2~1_combout\ & (((!\SW[1]~input_o\)))) # (!\C1|DRAW2~1_combout\ & (!\SW[0]~input_o\ & ((\C1|DRAW1~1_combout\))))
...
\C1|B~1\ : cycloneiv_lcell_comb
-- Equation(s):
-- \C1|B~1_combout\ = (\C1|DRAW2~1_combout\) # ((\C1|DRAW1~1_combout\ & !\SW[0]~input_o\))
...
\C1|process_0~11\ : cycloneiv_lcell_comb
-- Equation(s):
-- \C1|process_0~11_combout\ = (\C1|DRAW1~1_combout\) # ((\C1|LessThan6~20_combout\ & (\C1|LessThan4~20_combout\ & \C1|DRAW2~0_combout\)))
